...
public:
  ...
  /**
   * Create RedisInventoryManager component
   */
  OATPP_CREATE_COMPONENT(std::shared_ptr<RedisInventoryManager>, redisInventoryManager)([] {
    return std::make_shared<RedisInventoryManager>();
  }());
